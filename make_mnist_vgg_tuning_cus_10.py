...
class model_VGG(Model):
    def __init__(self):
        ...
        self.conv1_1 = Conv2D(5,(3,3),strides= (1,1),activation=tf.nn.relu, padding='same')
        self.conv1_2 = Conv2D(5,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.pool1 = MaxPooling2D(2,2)
        self.conv2_1 = Conv2D(10,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.conv2_2 = Conv2D(10,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.pool2 = MaxPooling2D(2,2)
        self.conv3_1 = Conv2D(20,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.conv3_2 = Conv2D(20,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.conv3_3 = Conv2D(20,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.pool3 = MaxPooling2D(2,2)
        self.conv4_1 = Conv2D(30,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.conv4_2 = Conv2D(30,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.conv4_3 = Conv2D(30,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.pool4 = MaxPooling2D(2,2)
        self.conv4_4 = Conv2D(30,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.conv4_5 = Conv2D(30,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
        self.conv4_6 = Conv2D(30,(3,3), strides=(1,1), activation=tf.nn.relu, padding='same')
...
myGpuModel.save('saved_model/mnist_16')
