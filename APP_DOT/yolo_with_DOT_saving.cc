...
#define Max_Delegated_Partitions_Num 7 
#define GPU
...
int main(int argc, char* argv[]) {
  ...
  int DOT_number  = combination(Partition_Num, Max_Delegated_Partitions_Num);
  int image_number = 1;
  vector<cv::Mat> input;
  for (int loop_num=0;loop_num<300;loop_num++){ 
    ...
    make_txt_to_get_mAP(yolo::YOLO_Parser::result_boxes, image_number);
