...
model = Sequential()
model.add(Conv2D(10, kernel_size=(3,3), input_shape=input_shape, activation=tf.nn.leaky_relu))
model.add(Dropout(0.2))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Conv2D(20, kernel_size=(3,3), activation=tf.nn.leaky_relu))
model.add(Dropout(0.2))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Conv2D(40, kernel_size=(3,3), activation = tf.nn.leaky_relu))
model.add(Dropout(0.2))
model.add(Flatten())
